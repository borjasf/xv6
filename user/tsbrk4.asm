...
main(int argc, char *argv[])
{
  ...
  47:	68 04 04 00 00       	push   $0x404
  4c:	6a 01                	push   $0x1
  4e:	e8 4e 02 00 00       	call   2a1 <printf>
    exit(1);
  ...
  73:	68 29 04 00 00       	push   $0x429
  78:	6a 01                	push   $0x1
  7a:	e8 22 02 00 00       	call   2a1 <printf>
    exit(2);
  ...
  a2:	68 42 04 00 00       	push   $0x442
  a7:	6a 01                	push   $0x1
  a9:	e8 f3 01 00 00       	call   2a1 <printf>
    exit(3);
  ...
  cd:	50                   	push   %eax
  ce:	68 5b 04 00 00       	push   $0x45b
  d3:	6a 01                	push   $0x1
  d5:	e8 c7 01 00 00       	call   2a1 <printf>
 ...
 12d:	52                   	push   %edx
 12e:	68 5b 04 00 00       	push   $0x45b
 133:	6a 01                	push   $0x1
 135:	e8 67 01 00 00       	call   2a1 <printf>
...
000001fe <getprio>:
SYSCALL(getprio)
 1fe:	b8 18 00 00 00       	mov    $0x18,%eax
 203:	cd 40                	int    $0x40
 205:	c3                   	ret

00000206 <setprio>:
 206:	b8 19 00 00 00       	mov    $0x19,%eax
 20b:	cd 40                	int    $0x40
 20d:	c3                   	ret
...
putc(int fd, char c)
{
 ...
 211:	83 ec 1c             	sub    $0x1c,%esp
 214:	88 55 f4             	mov    %dl,-0xc(%ebp)
  write(fd, &c, 1);
 217:	6a 01                	push   $0x1
 219:	8d 55 f4             	lea    -0xc(%ebp),%edx
 21c:	52                   	push   %edx
 21d:	50                   	push   %eax
 21e:	e8 4b ff ff ff       	call   16e <write>
}
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 22c:	56                   	push   %esi
 22d:	53                   	push   %ebx
 22e:	83 ec 2c             	sub    $0x2c,%esp
 231:	89 45 d4             	mov    %eax,-0x2c(%ebp)
 234:	89 ce                	mov    %ecx,%esi
  ...
  neg = 0;
  if(sgn && xx < 0){
 236:	83 7d 08 00          	cmpl   $0x0,0x8(%ebp)
 23a:	74 04                	je     240 <printint+0x18>
 23c:	85 d2                	test   %edx,%edx
 23e:	78 3c                	js     27c <printint+0x54>
    neg = 1;
    x = -xx;
  } else {
    x = xx;
 240:	89 d1                	mov    %edx,%ecx
  neg = 0;
 242:	c7 45 d0 00 00 00 00 	movl   $0x0,-0x30(%ebp)
  }

  i = 0;
 249:	bb 00 00 00 00       	mov    $0x0,%ebx
  do{
    buf[i++] = digits[x % base];
 ...
 259:	43                   	inc    %ebx
 25a:	8a 92 d0 04 00 00    	mov    0x4d0(%edx),%dl
 260:	88 54 3d d8          	mov    %dl,-0x28(%ebp,%edi,1)
  }while((x /= base) != 0);
 264:	89 ca                	mov    %ecx,%edx
 266:	89 c1                	mov    %eax,%ecx
 268:	39 f2                	cmp    %esi,%edx
 26a:	73 e2                	jae    24e <printint+0x26>
  if(neg)
 26c:	83 7d d0 00          	cmpl   $0x0,-0x30(%ebp)
 270:	74 24                	je     296 <printint+0x6e>
    buf[i++] = '-';
 272:	c6 44 1d d8 2d       	movb   $0x2d,-0x28(%ebp,%ebx,1)
 277:	8d 5f 02             	lea    0x2(%edi),%ebx
 27a:	eb 1a                	jmp    296 <printint+0x6e>
    x = -xx;
 ...
 280:	c7 45 d0 01 00 00 00 	movl   $0x1,-0x30(%ebp)
    x = -xx;
 287:	eb c0                	jmp    249 <printint+0x21>

  while(--i >= 0)
    putc(fd, buf[i]);
 289:	0f be 54 1d d8       	movsbl -0x28(%ebp,%ebx,1),%edx
 28e:	8b 45 d4             	mov    -0x2c(%ebp),%eax
 291:	e8 78 ff ff ff       	call   20e <putc>
  while(--i >= 0)
 296:	4b                   	dec    %ebx
 297:	79 f0                	jns    289 <printint+0x61>
}
...
printf(int fd, const char *fmt, ...)
{
 ...
 2c1:	e8 48 ff ff ff       	call   20e <putc>
 2c6:	eb 05                	jmp    2cd <printf+0x2c>
      }
    } else if(state == '%'){
 2c8:	83 fe 25             	cmp    $0x25,%esi
 2cb:	74 22                	je     2ef <printf+0x4e>
  for(i = 0; fmt[i]; i++){
 2cd:	43                   	inc    %ebx
 2ce:	8b 45 0c             	mov    0xc(%ebp),%eax
 2d1:	8a 04 18             	mov    (%eax,%ebx,1),%al
 2d4:	84 c0                	test   %al,%al
 2d6:	0f 84 1d 01 00 00    	je     3f9 <printf+0x158>
    c = fmt[i] & 0xff;
 2dc:	0f be f8             	movsbl %al,%edi
 2df:	0f b6 c0             	movzbl %al,%eax
    if(state == 0){
 2e2:	85 f6                	test   %esi,%esi
 2e4:	75 e2                	jne    2c8 <printf+0x27>
      if(c == '%'){
 2e6:	83 f8 25             	cmp    $0x25,%eax
 2e9:	75 d1                	jne    2bc <printf+0x1b>
        state = '%';
 2eb:	89 c6                	mov    %eax,%esi
 2ed:	eb de                	jmp    2cd <printf+0x2c>
      if(c == 'd'){
 2ef:	83 f8 25             	cmp    $0x25,%eax
 2f2:	0f 84 cc 00 00 00    	je     3c4 <printf+0x123>
 2f8:	0f 8c da 00 00 00    	jl     3d8 <printf+0x137>
 2fe:	83 f8 78             	cmp    $0x78,%eax
 301:	0f 8f d1 00 00 00    	jg     3d8 <printf+0x137>
 307:	83 f8 63             	cmp    $0x63,%eax
 30a:	0f 8c c8 00 00 00    	jl     3d8 <printf+0x137>
 310:	83 e8 63             	sub    $0x63,%eax
 313:	83 f8 15             	cmp    $0x15,%eax
 316:	0f 87 bc 00 00 00    	ja     3d8 <printf+0x137>
 31c:	ff 24 85 78 04 00 00 	jmp    *0x478(,%eax,4)
        printint(fd, *ap, 10, 1);
 323:	8b 7d e4             	mov    -0x1c(%ebp),%edi
 326:	8b 17                	mov    (%edi),%edx
 328:	83 ec 0c             	sub    $0xc,%esp
 32b:	6a 01                	push   $0x1
 32d:	b9 0a 00 00 00       	mov    $0xa,%ecx
 332:	8b 45 08             	mov    0x8(%ebp),%eax
 335:	e8 ee fe ff ff       	call   228 <printint>
        ap++;
 ...
 348:	eb 83                	jmp    2cd <printf+0x2c>
        printint(fd, *ap, 16, 0);
 34a:	8b 7d e4             	mov    -0x1c(%ebp),%edi
 34d:	8b 17                	mov    (%edi),%edx
 34f:	83 ec 0c             	sub    $0xc,%esp
 352:	6a 00                	push   $0x0
 354:	b9 10 00 00 00       	mov    $0x10,%ecx
 359:	8b 45 08             	mov    0x8(%ebp),%eax
 35c:	e8 c7 fe ff ff       	call   228 <printint>
        ap++;
 ...
 36a:	be 00 00 00 00       	mov    $0x0,%esi
        ap++;
 36f:	e9 59 ff ff ff       	jmp    2cd <printf+0x2c>
        s = (char*)*ap;
 374:	8b 45 e4             	mov    -0x1c(%ebp),%eax
 377:	8b 30                	mov    (%eax),%esi
        ap++;
 379:	83 c0 04             	add    $0x4,%eax
 37c:	89 45 e4             	mov    %eax,-0x1c(%ebp)
        if(s == 0)
 37f:	85 f6                	test   %esi,%esi
 381:	75 13                	jne    396 <printf+0xf5>
          s = "(null)";
 383:	be 71 04 00 00       	mov    $0x471,%esi
 388:	eb 0c                	jmp    396 <printf+0xf5>
          putc(fd, *s);
 38a:	0f be d2             	movsbl %dl,%edx
 38d:	8b 45 08             	mov    0x8(%ebp),%eax
 390:	e8 79 fe ff ff       	call   20e <putc>
          s++;
 395:	46                   	inc    %esi
        while(*s != 0){
 396:	8a 16                	mov    (%esi),%dl
 398:	84 d2                	test   %dl,%dl
 39a:	75 ee                	jne    38a <printf+0xe9>
      state = 0;
 39c:	be 00 00 00 00       	mov    $0x0,%esi
 3a1:	e9 27 ff ff ff       	jmp    2cd <printf+0x2c>
        putc(fd, *ap);
 3a6:	8b 7d e4             	mov    -0x1c(%ebp),%edi
 3a9:	0f be 17             	movsbl (%edi),%edx
 3ac:	8b 45 08             	mov    0x8(%ebp),%eax
 3af:	e8 5a fe ff ff       	call   20e <putc>
        ap++;
 3b4:	83 c7 04             	add    $0x4,%edi
 3b7:	89 7d e4             	mov    %edi,-0x1c(%ebp)
      state = 0;
 3ba:	be 00 00 00 00       	mov    $0x0,%esi
 3bf:	e9 09 ff ff ff       	jmp    2cd <printf+0x2c>
        putc(fd, c);
 3c4:	89 fa                	mov    %edi,%edx
 3c6:	8b 45 08             	mov    0x8(%ebp),%eax
 3c9:	e8 40 fe ff ff       	call   20e <putc>
      state = 0;
 3ce:	be 00 00 00 00       	mov    $0x0,%esi
 3d3:	e9 f5 fe ff ff       	jmp    2cd <printf+0x2c>
        putc(fd, '%');
 3d8:	ba 25 00 00 00       	mov    $0x25,%edx
 3dd:	8b 45 08             	mov    0x8(%ebp),%eax
 3e0:	e8 29 fe ff ff       	call   20e <putc>
        putc(fd, c);
 3e5:	89 fa                	mov    %edi,%edx
 3e7:	8b 45 08             	mov    0x8(%ebp),%eax
 3ea:	e8 1f fe ff ff       	call   20e <putc>
      state = 0;
 3ef:	be 00 00 00 00       	mov    $0x0,%esi
 3f4:	e9 d4 fe ff ff       	jmp    2cd <printf+0x2c>
    }
  }
}
