...
0000008b <runcmd>:
{
  ...
  a0:	ff 24 85 7c 10 00 00 	jmp    *0x107c(,%eax,4)
    exit(0);
...
int gettoken(char **ps, char *es, char **q, char **eq)
{
 ...
 388:	50                   	push   %eax
 389:	68 94 16 00 00       	push   $0x1694
 ...
 3fa:	50                   	push   %eax
 3fb:	68 94 16 00 00       	push   $0x1694
 ...
 412:	50                   	push   %eax
 413:	68 8c 16 00 00       	push   $0x168c
 ...
 444:	50                   	push   %eax
 445:	68 94 16 00 00       	push   $0x1694
...
int peek(char **ps, char *es, char *toks)
{
 ...
 483:	50                   	push   %eax
 484:	68 94 16 00 00       	push   $0x1694
...
nulterminate(struct cmd *cmd)
{
 ...
 810:	ff 24 85 94 10 00 00 	jmp    *0x1094(,%eax,4)
  {
  case EXEC:
...
00000890 <parsecmd>:
{
 ...
 8b5:	68 73 10 00 00       	push   $0x1073
 8ba:	53                   	push   %ebx
...
000008fc <main>:
{
 ...
 96b:	6a 64                	push   $0x64
 96d:	68 a0 16 00 00       	push   $0x16a0
 ...
 982:	80 3d a0 16 00 00 63 	cmpb   $0x63,0x16a0
 989:	75 ab                	jne    936 <main+0x3a>
 98b:	80 3d a1 16 00 00 64 	cmpb   $0x64,0x16a1
 992:	75 a2                	jne    936 <main+0x3a>
 994:	80 3d a2 16 00 00 20 	cmpb   $0x20,0x16a2
 99b:	75 99                	jne    936 <main+0x3a>
      buf[strlen(buf) - 1] = 0; // chop \n
 99d:	83 ec 0c             	sub    $0xc,%esp
 9a0:	68 a0 16 00 00       	push   $0x16a0
 9a5:	e8 c7 00 00 00       	call   a71 <strlen>
 9aa:	c6 80 9f 16 00 00 00 	movb   $0x0,0x169f(%eax)
      if (chdir(buf + 3) < 0)
 9b1:	c7 04 24 a3 16 00 00 	movl   $0x16a3,(%esp)
 ...
 9c7:	68 a3 16 00 00       	push   $0x16a3
 ...
 9e0:	68 a0 16 00 00       	push   $0x16a0
 ...
 a10:	4a                   	dec    %edx
 a11:	52                   	push   %edx
 a12:	68 63 10 00 00       	push   $0x1063
 a17:	6a 02                	push   $0x2
...
strlen(const char *s)
{
 ...
 a7e:	40                   	inc    %eax
 a7f:	80 3c 02 00          	cmpb   $0x0,(%edx,%eax,1)
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 cbd:	43                   	inc    %ebx
 cbe:	8a 92 04 11 00 00    	mov    0x1104(%edx),%dl
 cc4:	88 54 3d d8          	mov    %dl,-0x28(%ebp,%edi,1)
  }while((x /= base) != 0);
 cc8:	89 ca                	mov    %ecx,%edx
 cca:	89 c1                	mov    %eax,%ecx
 ccc:	39 f2                	cmp    %esi,%edx
 cce:	73 e2                	jae    cb2 <printint+0x26>
  if(neg)
...
printf(int fd, const char *fmt, ...)
{
 ...
 d80:	ff 24 85 ac 10 00 00 	jmp    *0x10ac(,%eax,4)
        printint(fd, *ap, 10, 1);
 ...
 de5:	75 13                	jne    dfa <printf+0xf5>
          s = "(null)";
 de7:	be 74 10 00 00       	mov    $0x1074,%esi
...
free(void *ap)
{
 ...
 ead:	89 08                	mov    %ecx,(%eax)
  freep = p;
 eaf:	a3 04 17 00 00       	mov    %eax,0x1704
}
 eb4:	5b                   	pop    %ebx
 eb5:	5e                   	pop    %esi
 eb6:	5f                   	pop    %edi
...
morecore(uint nu)
{
 ...
 f0c:	e8 54 ff ff ff       	call   e65 <free>
  return freep;
 f11:	a1 04 17 00 00       	mov    0x1704,%eax
...
malloc(uint nbytes)
{
 ...
 f35:	43                   	inc    %ebx
  if((prevp = freep) == 0){
 f36:	8b 0d 04 17 00 00    	mov    0x1704,%ecx
 ...
 f42:	eb 4a                	jmp    f8e <malloc+0x69>
    base.s.ptr = freep = prevp = &base;
 f44:	c7 05 04 17 00 00 08 	movl   $0x1708,0x1704
 f4b:	17 00 00 
 f4e:	c7 05 08 17 00 00 08 	movl   $0x1708,0x1708
 f55:	17 00 00 
    base.s.size = 0;
 f58:	c7 05 0c 17 00 00 00 	movl   $0x0,0x170c
 f5f:	00 00 00 
    base.s.ptr = freep = prevp = &base;
 f62:	b9 08 17 00 00       	mov    $0x1708,%ecx
 ...
 f73:	89 58 04             	mov    %ebx,0x4(%eax)
      ...
      freep = prevp;
 f76:	89 0d 04 17 00 00    	mov    %ecx,0x1704
      return (void*)(p + 1);
 ...
 f93:	73 d4                	jae    f69 <malloc+0x44>
    if(p == freep)
 f95:	39 05 04 17 00 00    	cmp    %eax,0x1704
