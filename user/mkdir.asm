...
main(int argc, char *argv[])
{
  ...
  51:	ff 36                	push   (%esi)
  53:	e8 95 00 00 00       	call   ed <mkdir>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 190:	43                   	inc    %ebx
 191:	8a 92 cc 03 00 00    	mov    0x3cc(%edx),%dl
...
printf(int fd, const char *fmt, ...)
{
 ...
 253:	ff 24 85 74 03 00 00 	jmp    *0x374(,%eax,4)
        printint(fd, *ap, 10, 1);
 ...
 2b8:	75 13                	jne    2cd <printf+0xf5>
          s = "(null)";
 2ba:	be 6b 03 00 00       	mov    $0x36b,%esi
