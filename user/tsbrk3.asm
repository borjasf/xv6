...
printint(int fd, int xx, int base, int sgn)
{
 ...
 185:	43                   	inc    %ebx
 186:	8a 92 d4 03 00 00    	mov    0x3d4(%edx),%dl
 18c:	88 54 3d d8          	mov    %dl,-0x28(%ebp,%edi,1)
  }while((x /= base) != 0);
 190:	89 ca                	mov    %ecx,%edx
 192:	89 c1                	mov    %eax,%ecx
 194:	39 f2                	cmp    %esi,%edx
 196:	73 e2                	jae    17a <printint+0x26>
  if(neg)
...
printf(int fd, const char *fmt, ...)
{
 ...
 248:	ff 24 85 7c 03 00 00 	jmp    *0x37c(,%eax,4)
        printint(fd, *ap, 10, 1);
 ...
 2ad:	75 13                	jne    2c2 <printf+0xf5>
          s = "(null)";
 2af:	be 3b 03 00 00       	mov    $0x33b,%esi
