...
printint(int fd, int xx, int base, int sgn)
{
 ...
 477:	39 f2                	cmp    %esi,%edx
 479:	73 e2                	jae    45d <printint+0x26>
  if(neg)
...
printf(int fd, const char *fmt, ...)
{
 ...
 590:	75 13                	jne    5a5 <printf+0xf5>
          s = "(null)";
 592:	be d3 08 00 00       	mov    $0x8d3,%esi
