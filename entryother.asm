...
spin:
  jmp     spin
    ...
    706b:	2e 8d 74 26 00       	lea    %cs:0x0(%esi,%eiz,1),%esi

00007070 <gdt>:
	...
    7078:	ff                   	(bad)
    7079:	ff 00                	incl   (%eax)
    707b:	00 00                	add    %al,(%eax)
    707d:	9a cf 00 ff ff 00 00 	lcall  $0x0,$0xffff00cf
    7084:	00                   	.byte 0
    7085:	92                   	xchg   %eax,%edx
    7086:	cf                   	iret
	...

00007088 <gdtdesc>:
    7088:	17                   	pop    %ss
    7089:	00 70 70             	add    %dh,0x70(%eax)
	...
